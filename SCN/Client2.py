...
# Load data
n = 600                   # Sample  size
data = np.load("./data/dataset2.npz", allow_pickle=True)
Xtrain = data['Xtrain']   # 400*1
Ttrain = data['Ttrain']   # 400*1
Xtest = data['Xtest']
Ttest = data['Ttest']
...
plt.plot(ErrorPlot), plt.xlabel('Iteration'), plt.ylabel('Error'), plt.title('Client2 ErrorTrain Curve'), plt.show()